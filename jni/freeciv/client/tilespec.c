...
static void tileset_lookup_sprite_tags(struct tileset *t)
{
  ...
  report_tileset_progress("loading_indicators");
  ...
  report_tileset_progress("loading_mask");
  ...
  report_tileset_progress("loading_spaceship");
  ...
  report_tileset_progress("loading_cursors");
  ...
  report_tileset_progress("loading_roads");
  ...
  report_tileset_progress("loading_unitinfo");
  ...
  report_tileset_progress("loading_cities");
...
#undef SET_EDITOR_SPRITE
  ...
  report_tileset_progress("loading_overlays");
  ...
  report_tileset_progress("loading_farmland");
  ...
  report_tileset_progress("loading_fog");
...
void tileset_free_big_sprites(struct tileset *t)
{
			     ...
			     const struct terrain *pterrain)
{
  ...
  report_tileset_progress(terrain_rule_name(pterrain));
